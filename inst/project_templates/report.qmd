...
<!-- An example of how to cross reference a figure is included below. More information 
can be found here: https://quarto.org/docs/authoring/cross-references.html
