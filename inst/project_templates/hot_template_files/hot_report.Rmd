...
<!-- To cite a reference within the document, the ref must be included in the `templates/references.bib` file. Use square brackets and @ with the shorthand term. -->
<!-- Ex: The generalized additive model models the relationship between the mean of the response variable and sum of smooth functions of the explanatory variables [@hastie1986gam].  -->
<!-- Use `citation("gtsummary") |> toBibtex()` to obtain a bib entry for any packages not already included. Be sure to give a citekey (aka name) that matches the package name. -->
