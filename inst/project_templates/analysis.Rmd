...
{{(ifelse(tolower(Sys.info()[["user"]]) %in% eval(as.list(bstfun::theme_gtsummary_msk)$name), glue::glue("# Set custom gtsummary theme if exists in the bstfun::theme_gtsummary_msk
